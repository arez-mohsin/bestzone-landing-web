    ...
    <section id="coverage" className="py-24 bg-white overflow-hidden relative">
      <div className="container mx-auto px-6 max-w-[1280px]">
        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-16">
          <motion.div
            initial={{ opacity: 0, filter: 'blur(4px)', willChange: 'transform, opacity, filter', y: 16 }}
          ...
          <motion.h2
            ...
            className="text-[clamp(34px,4vw,48px)] leading-[1.1] font-bold text-bz-ink mb-6 text-balance"
          >
            {t('coverage.title1')} <br />
            <span className="text-bz-blue">{t('coverage.title2')}</span>
          </motion.h2>
          ...
          <motion.p
            ...
            className="text-lg text-bz-text leading-relaxed mb-10"
          >
            {t('coverage.desc')}
          </motion.p>
        </div>
        ...
        <motion.div
          initial={{ opacity: 0, filter: 'blur(4px)', willChange: 'transform, opacity, filter', scale: 0.98 }}
        ...
        <div className="flex items-center justify-center gap-6 mt-8">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-bz-text">{t('coverage.kurdistan')}</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-bz-blue"></div>
            <span className="text-sm font-medium text-bz-text">{t('coverage.iraq')}</span>
          </div>
        </div>
