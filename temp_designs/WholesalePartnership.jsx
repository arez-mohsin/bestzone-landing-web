...
const benefits = [
  ...
  "Fast and dependable distribution",
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-20">
          ...
          >
            <motion.div 
              ...
              className="px-4 py-1.5 rounded-full glass-card-dark text-xs font-bold tracking-widest text-white mb-6 border-white/20"
            >
              WHOLESALE
            </motion.div>
            ...
            >
              Let's Build <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-bz-blue to-[#60b3f7]">Success Together.</span>
            </motion.h2>
            ...
            >
              BestZone empowers retailers, resellers, and business partners across Iraq and Kurdistan with aggressive wholesale pricing, dependable supply, and dedicated support.
            </motion.p>
